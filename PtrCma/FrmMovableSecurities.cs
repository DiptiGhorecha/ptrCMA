...
namespace PtrCma
{
    public partial class FrmImmovableSecurities : Form
    {
        public Action NotifyMainFormToCloseChildFormParty;
        public Action NotifyMainFormToCloseChildFormImmovable;
        ...
        public FrmImmovableSecurities()
        {
            InitializeComponent();
        }

        private void FrmImmovableSecurities_Load(object sender, EventArgs e)
        {
        ...
        private void filltempTable()
        {
            try
            {
                ...
                string sqlTrunc = "DELETE FROM Cp_Cd112";
                OleDbDataAdapter myadapter = new OleDbDataAdapter();
                DataSet ds1 = new DataSet();
                String sql = "INSERT INTO Cp_Cd112 SELECT * FROM Cx_Cd112 WHERE CL_REFNO=" + Global.prtyCode;
        ...
        private void fillgrid()
        {
            try
            {
                ...
                dataAdapter = new OleDbDataAdapter("select * from Cp_Cd112 WHERE CL_REFNO=" + Global.prtyCode, con);
                dataAdapter.Fill(ds, "Cp_Cd112");
                grdViewSecurities.DataMember = "Cp_Cd112";
                ...
                grdViewSecurities.Columns[0].HeaderText = "Description of Property";
        ...
        private void LoadDatatoTextBox()
        {
            if (grdViewSecurities.RowCount > 0)    // No Crashing problem when there is no data in gridview
            {
                ...
                txtProperty.Text = row.Cells["CTXT03"].Value.ToString();
                txtValuation.Text = row.Cells["CTXT04"].Value.ToString();
            }
        }
        ...
        private void btnExit_Click(object sender, EventArgs e)
        {
            ...
            {
                NotifyMainFormToCloseChildFormImmovable();
                this.Hide();
            }
        }
        ...
        private void cmdUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (isAddEdit == "A")
            {
                sql = "insert into Cp_Cd112(CTXT01,CTXT02,CTXT03,CTXT04,CL_REFNO) values ('" + txtDes.Text + "','" + txtOwner.Text + "','" + txtProperty.Text + "','" + txtValuation.Text + "'," + Global.prtyCode + ")";
            }
            else
            {
                sql = "update Cp_Cd112 set CTXT01='" + txtDes.Text + "',CTXT02='" + txtOwner.Text + "',CTXT03='" + txtProperty.Text + "',CTXT04='" + txtValuation.Text + "' WHERE CTX_REF=" + txtRef.Text + " AND CL_REFNO=" + Global.prtyCode;
            }
